...
AddEventHandler('esx_giveownedcar:setVehicle', function (vehicleProps, playerID, vehicleType)
	...
	MySQL.Async.execute('INSERT INTO owned_vehicles (owner, plate, vehicle, stored, garage_name, type) VALUES (@owner, @plate, @vehicle, @stored,@garage_name, @type)',
	{
		['@owner']   = xPlayer.identifier,
		['@plate']   = vehicleProps.plate,
		['@vehicle'] = json.encode(vehicleProps),
		['@stored']  = 1,
		['@garage_name'] = "Garage_Centre",
		['type'] = vehicleType
	}, function ()
