Config = {}
Config.Blip			= {sprite= 524, color = 32}
...
Config.Garages = {
	Garage_Centre = {
		...
		Name = ('garage_name'),
		HelpPrompt = ('open_car_garage'),
		SpawnPoint = {
			Pos = {x=229.700, y= -800.1149, z= 30.5722},
			Heading = 160.0,
			Marker = { w= 1.5, h= 2.0,r=0,g=255,b=0},
			HelpPrompt = ('spawn_car')
		},
		DeletePoint = {
			Pos = {x=215.124, y=-791.377, z=30.946},
			Marker = { w= 1.5, h= 2.0,r=255,g=0,b=0},
			HelpPrompt = ('store_car')
		}, 	
	},
	Garage_NightClub = {
	...
	Garage_Centre2 = {
		Pos = {x = -1523.191,y = -452.017,z = 35.596},
		Marker = { w= 1.5, h= 2.0,r = 204, g = 204, b = 0},
		Name = ('garage_name'),
		HelpPrompt = ('open_car_garage'),
		SpawnPoint = {
	...
	Garage_SandyShore = {
		...
		DeletePoint = {
			Pos = {x = 1695.156,y = 3602.061,z = 35.530},
			Marker = { w= 1.5, h= 2.0,r=255,g=0,b=0},
			HelpPrompt = ('store_car')
		}, 	
	},
...
Config.GaragesMecano = {
	Bennys = {
		...
		SpawnPoint = {
			...
			Heading = 303.0,
			Marker = { w= 1.5, h= 2.0,r=0,g=255,b=0},
			HelpPrompt = ('take_from_pound')
		},
		DeletePoint = {
			Pos = {x = 459.733,y = -1890.335,z = 25.776},
			Marker = { w= 1.5, h= 2.0,r=255,g=0,b=0},
			HelpPrompt = ('store_in_pound')
		}, 	
	},
	police = {
		Name = ('police_pound'),
...
Config.BoatGarages = {
	BoatGarage_Centre = {
		...
		Marker = { w= 1.5, h= 2.0,r = 204, g = 204, b = 0},
		Name = ('boat_garage_name'),
		HelpPrompt = ('open_boat_garage'),
		SpawnPoint = {
			Pos = {x = -736.47064208984,y = -1342.4702148438,z = 2.0 },
			MarkerPos = {x = -733.58,y = -1338.62,z = 1.5 },
			Heading = 230.0,
			Marker = { w= 1.5, h= 2.0,r=0,g=255,b=0},
			HelpPrompt = ('spawn_boat')
		},
		DeletePoint = {
			Pos = {x = -740.06408691406,y = -1361.8474121094,z = 1.8801808655262 },
			Marker = { w= 3.5, h= 2.0,r=255,g=0,b=0},
			HelpPrompt = ('store_boat')
		}, 	
	},
}
	...
	police =  { -- database job name
		{
			...
			Marker = { w= 1.5, h= 2.0,r = 204, g = 204, b = 0},
			Name = ('police_garage_name'),
			HelpPrompt = ('open_police_garage'),
			SpawnPoint = {
				Pos = {x = -1285.1153564453,y = -3382.1647949219,z = 13.940155029297 },
				Heading = 160.0,
				Marker = { w= 1.5, h= 2.0,r=0,g=255,b=0},
				HelpPrompt = ('spawn_police_garage')
			},
			DeletePoint = {
				Pos = {x = -1287.5788574219,y = -3390.4025878906,z = 13.940155029297 },
				Marker = { w= 1.5, h= 2.0,r=255,g=0,b=0},
				HelpPrompt = ('store_police_garage')
			}, 	
		},
		{
	...
	brinks =  {
		{
			...
			Marker = { w= 1.5, h= 2.0,r = 204, g = 204, b = 0},
			Name = ('brinks_garage_name'),
			HelpPrompt = ('open_brinks_garage'),
			SpawnPoint = {
				Pos = {x = -1285.1153564453,y = -3382.1647949219,z = 13.940155029297 },
				Heading = 160.0,
				Marker = { w= 1.5, h= 2.0,r=0,g=255,b=0},
				HelpPrompt = ('spawn_brinks_garage')
			},
			DeletePoint = {
				Pos = {x = -1287.5788574219,y = -3390.4025878906,z = 13.940155029297 },
				Marker = { w= 1.5, h= 2.0,r=255,g=0,b=0},
				HelpPrompt = ('store_brinks_garage')
			}, 	
		},
    },
	ambulance =  {
		{
			Pos = {x = 443.1153564453,y = -993.86,z = 30.696 },
			Marker = { w= 1.5, h= 2.0,r = 204, g = 204, b = 0},
			Name = ('ambulance_garage_name'),
			HelpPrompt = ('open_ambulance_garage'),
			SpawnPoint = {
				Pos = {x = -1285.1153564453,y = -3382.1647949219,z = 13.940155029297 },
				Heading = 160.0,
				Marker = { w= 1.5, h= 2.0,r=0,g=255,b=0},
				HelpPrompt = ('spawn_ambulance_garage')
			},
			DeletePoint = {
				Pos = {x = -1287.5788574219,y = -3390.4025878906,z = 13.940155029297 },
				Marker = { w= 1.5, h= 2.0,r=255,g=0,b=0},
				HelpPrompt = ('store_ambulance_garage')
			}, 	
		},
	},
	taxi =  {
		{
			Pos = {x = 443.1153564453,y = -993.86,z = 30.696 },
			Marker = { w= 1.5, h= 2.0,r = 204, g = 204, b = 0},
			Name = ('taxi_garage_name'),
			HelpPrompt = ('open_taxi_garage'),
			SpawnPoint = {
				Pos = {x = -1285.1153564453,y = -3382.1647949219,z = 13.940155029297 },
				Heading = 160.0,
				Marker = { w= 1.5, h= 2.0,r=0,g=255,b=0},
				HelpPrompt = ('spawn_taxi_garage')
			},
			DeletePoint = {
				Pos = {x = -1287.5788574219,y = -3390.4025878906,z = 13.940155029297 },
				Marker = { w= 1.5, h= 2.0,r=255,g=0,b=0},
				HelpPrompt = ('store_taxi_garage')
			}, 	
		},
    },
}
